...
def calculate_weighted_means(results):
    ...
    for result in results:
        ...
        unemployment_rate_6m.append(result.get('unemployment_rate_6m', np.nan))
        unemployment_rate_12m.append(result.get('unemployment_rate_12m', np.nan))
        unemployment_rate_18m.append(result.get('unemployment_rate_18m', np.nan))
        unemployment_rate_24m.append(result.get('unemployment_rate_24m', np.nan))
        
        gdp.append(result.get('gdp', np.nan))
        gdp_6m.append(result.get('gdp_6m', np.nan))
        gdp_12m.append(result.get('gdp_12m', np.nan))
        gdp_18m.append(result.get('gdp_18m', np.nan))
        gdp_24m.append(result.get('gdp_24m', np.nan))
        
        oil_price.append(result.get('oil_price', np.nan))
        oil_price_6m.append(result.get('oil_price_6m', np.nan))
        oil_price_12m.append(result.get('oil_price_12m', np.nan))
        oil_price_18m.append(result.get('oil_price_18m', np.nan))
        oil_price_24m.append(result.get('oil_price_24m', np.nan))
        
        cpi.append(result.get('cpi', np.nan))
        cpi_6m.append(result.get('cpi_6m', np.nan))
        cpi_12m.append(result.get('cpi_12m', np.nan))
        cpi_18m.append(result.get('cpi_18m', np.nan))
        cpi_24m.append(result.get('cpi_24m', np.nan))
